...
//add by chuming.zhang@elanic.com.cn
#ifdef CONFIG_ELAN_SPI_TOUCHSCREEN
struct elan_spitouch_platform_data {
...
static struct elan_spitouch_platform_data elan_spitouch_config = {
	.version   = 0x0001,
	.intr_gpio   = EXYNOS4_GPX3(3),//int15
	.rstr_gpio   = EXYNOS4_GPX3(2),//int27
	.lcm_xres	 = 800,
	.lcm_yres	 = 1200,
};
...
static struct spi_board_info spi1_board_info[] __initdata = {
	{
		.modalias		= "elanspi_ts",//"elan_ktf",
		.bus_num		= 1,
		.chip_select	= 0,
		.irq			= IRQ_EINT(27),
		.max_speed_hz	= 3*1000*1000,
		.mode			= SPI_MODE_0,
		.platform_data	= &elan_spitouch_config,
...
#ifdef CONFIG_TOUCHSCREEN_ELAN
#include <plat/elan_touch.h>
static struct elan_i2c_platform_data elan_pdata = {
	.intr_gpio = EXYNOS4_GPX1(7),
	.rst_gpio  = EXYNOS4_GPX3(4),
	.irq_num   = IRQ_EINT(15), 
	.screen_coordinate_x = 800,
	.screen_coordinate_y = 1280,
};
#endif 
...
#ifdef CONFIG_TOUCHSCREEN_ELAN
	{
		I2C_BOARD_INFO("elan_ts", (0x20 >> 1)),
		.platform_data = &elan_pdata,
	},
#endif
	{
...
#ifndef CONFIG_ELAN_SPI_TOUCHSCREEN
	{
		.gpio	= EXYNOS4_GPX3(2),
		.code	= KEY_MENU,
	}, {
...
#endif
#ifndef	CONFIG_TOUCHSCREEN_ELAN 
	{
		.gpio	= EXYNOS4_GPX3(4),
		.code	= KEY_BACK,
	},
